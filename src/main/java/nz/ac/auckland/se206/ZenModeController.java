...
public class ZenModeController extends CanvasController implements Initializable {
  ...
  /**
   * this method is the one that is responsible of the hover effect for save button when mouse
   * enters
   */
  @FXML
  ...
  /** this methods sets up the hover effect animation for pen 1 when mouse is pressed */
  @FXML
  private void onPressOne() {
    setZoomOnPress(imageOnOne);
  }

  /** this methods sets up the hover effect animation for pen 1 when mouse is entered */
  @FXML
  private void onEnterOne() {
    setZoomOnEnter(imageOnOne);
  }

  /** this methods sets up the hover effect animation for pen 1 when mouse is exited */
  @FXML
  private void onExitOne() {
    setZoomOnLeave(imageOnOne);
  }

  /** this methods sets up the hover effect animation for pen 2 when mouse is pressed */
  @FXML
  private void onPressTwo() {
    setZoomOnPress(imageOnTwo);
  }

  /** this methods sets up the hover effect animation for pen 2 when mouse is entered */
  @FXML
  private void onEnterTwo() {
    setZoomOnEnter(imageOnTwo);
  }

  /** this methods sets up the hover effect animation for pen 2 when mouse is exited */
  @FXML
  private void onExitTwo() {
    setZoomOnLeave(imageOnTwo);
  }

  /** this methods sets up the hover effect animation for pen 3 when mouse is pressed */
  @FXML
  private void onPressThree() {
    setZoomOnPress(imageOnThree);
  }

  /** this methods sets up the hover effect animation for pen 3 when mouse is entered */
  @FXML
  private void onEnterThree() {
    setZoomOnEnter(imageOnThree);
  }

  /** this methods sets up the hover effect animation for pen 3 when mouse is exited */
  @FXML
  private void onExitThree() {
    setZoomOnLeave(imageOnThree);
  }

  /** this methods sets up the hover effect animation for pen 4 when mouse is pressed */
  @FXML
  private void onPressFour() {
    setZoomOnPress(imageOnFour);
  }

  /** this methods sets up the hover effect animation for pen 4 when mouse is entered */
  @FXML
  private void onEnterFour() {
    setZoomOnEnter(imageOnFour);
  }

  /** this methods sets up the hover effect animation for pen 4 when mouse is exited */
  @FXML
  private void onExitFour() {
    setZoomOnLeave(imageOnFour);
  }

  /** this methods sets up the hover effect animation for pen 5 when mouse is pressed */
  @FXML
  private void onPressFive() {
    setZoomOnPress(imageOnFive);
  }

  /** this methods sets up the hover effect animation for pen 5 when mouse is entered */
  @FXML
  private void onEnterFive() {
    setZoomOnEnter(imageOnFive);
  }

  /** this methods sets up the hover effect animation for pen 5 when mouse is exited */
  @FXML
  private void onExitFive() {
    setZoomOnLeave(imageOnFive);
  }

  /** this methods sets up the hover effect animation for pen 6 when mouse is pressed */
  @FXML
  private void onPressSix() {
    setZoomOnPress(imageOnSix);
  }

  /** this methods sets up the hover effect animation for pen 6 when mouse is entered */
  @FXML
  private void onEnterSix() {
    setZoomOnEnter(imageOnSix);
  }

  /** this methods sets up the hover effect animation for pen 6 when mouse is exited */
  @FXML
  private void onExitSix() {
    setZoomOnLeave(imageOnSix);
  }

  /** this methods sets up the hover effect animation for pen 7 when mouse is pressed */
  @FXML
  private void onPressSeven() {
    setZoomOnPress(imageOnSeven);
  }

  /** this methods sets up the hover effect animation for pen 7 when mouse is entered */
  @FXML
  private void onEnterSeven() {
    setZoomOnEnter(imageOnSeven);
  }

  /** this methods sets up the hover effect animation for pen 7 when mouse is exited */
  @FXML
  private void onExitSeven() {
    setZoomOnLeave(imageOnSeven);
  }

  /** this methods sets up the hover effect animation for pen 8 when mouse is pressed */
  @FXML
  private void onPressEight() {
    setZoomOnPress(imageOnEight);
  }

  /** this methods sets up the hover effect animation for pen 8 when mouse is entered */
  @FXML
  private void onEnterEight() {
    setZoomOnEnter(imageOnEight);
  }

  /** this methods sets up the hover effect animation for pen 8 when mouse is exited */
  @FXML
  private void onExitEight() {
    setZoomOnLeave(imageOnEight);
  }

  /** this methods sets up the hover effect animation for pen 9 when mouse is pressed */
  @FXML
  private void onPressNine() {
    setZoomOnPress(imageOnNine);
  }

  /** this methods sets up the hover effect animation for pen 89 when mouse is entered */
  @FXML
  private void onEnterNine() {
    setZoomOnEnter(imageOnNine);
  }

  /** this methods sets up the hover effect animation for pen 9 when mouse is exited */
  @FXML
  private void onExitNine() {
    setZoomOnLeave(imageOnNine);
  }

  /** this methods sets up the hover effect animation for pen 10 when mouse is pressed */
  @FXML
  private void onPressTen() {
    setZoomOnPress(imageOnTen);
  }

  /** this methods sets up the hover effect animation for pen 10 when mouse is entered */
  @FXML
  private void onEnterTen() {
    setZoomOnEnter(imageOnTen);
  }

  /** this methods sets up the hover effect animation for pen 10 when mouse is exited */
  @FXML
  private void onExitTen() {
    setZoomOnLeave(imageOnTen);
  }

  /** this methods sets up the hover effect animation for pen 11 when mouse is pressed */
  @FXML
  private void onPressEleven() {
    setZoomOnPress(imageOnEleven);
  }

  /** this methods sets up the hover effect animation for pen 11 when mouse is entered */
  @FXML
  private void onEnterEleven() {
    setZoomOnEnter(imageOnEleven);
  }

  /** this methods sets up the hover effect animation for pen 11 when mouse is exited */
  @FXML
  private void onExitEleven() {
    setZoomOnLeave(imageOnEleven);
  }

  /** this methods sets up the hover effect animation for pen 12 when mouse is pressed */
  @FXML
  private void onPressTwelve() {
    setZoomOnPress(imageOnTwelve);
  }

  /** this methods sets up the hover effect animation for pen 12 when mouse is entered */
  @FXML
  private void onEnterTwelve() {
    setZoomOnEnter(imageOnTwelve);
  }

  /** this methods sets up the hover effect animation for pen 12 when mouse is exited */
  @FXML
