...
public class ProfileRepository {
	...
	private static final Path repoPathName = Paths.get("src/main/java/nz/ac/auckland/se206/user profile repository");
	private static HashMap<String, UserProfile> users;

	private static UserProfile currentUser;

	/**
	 * If the username doesn't already exist, the user profile is added to the
	 * HashMap and returns true Otherwise, the method does nothing and returns false
	 *
