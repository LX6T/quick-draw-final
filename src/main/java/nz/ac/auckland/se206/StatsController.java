...
public class StatsController {
	...
	@FXML
	private RadioButton radioAccuracyEasy;
	@FXML
	private RadioButton radioAccuracyMedium;
	@FXML
	private RadioButton radioAccuracyHard;
	@FXML
	private RadioButton radioWordsEasy;
	@FXML
	private RadioButton radioWordsMedium;
	@FXML
	private RadioButton radioWordsHard;
	@FXML
	private RadioButton radioWordsMaster;
	@FXML
	private RadioButton radioTimeEasy;
	@FXML
	private RadioButton radioTimeMedium;
	@FXML
	private RadioButton radioTimeHard;
	@FXML
	private RadioButton radioTimeMaster;
	@FXML
	private RadioButton radioConfidenceEasy;
	@FXML
	private RadioButton radioConfidenceMedium;
	@FXML
	private RadioButton radioConfidenceHard;
	@FXML
	private RadioButton radioConfidenceMaster;
	@FXML
	...
	@FXML
	private ToggleGroup words;
	@FXML
	private ToggleGroup time;
	@FXML
	private ToggleGroup confidence;
	@FXML
	private ToggleGroup hiddenWord;
	...
	public void setStats() {
		...
		if (settingsData.isComplete()) {
			...
			int accuracyDifficultyIndex = SettingsData.toDifficultyIndex(settingsData.getAccuracyDifficulty());
			...
			int confidenceDifficultyIndex = SettingsData.toDifficultyIndex(settingsData.getConfidenceDifficulty());
		...
		hiddenWord.selectedToggleProperty().addListener((observableValue, toggle, t1) -> {
		...
		accuracy.selectedToggleProperty().addListener((observableValue, toggle, t1) -> {
		...
		words.selectedToggleProperty().addListener((observableValue, toggle, t1) -> {
		...
		time.selectedToggleProperty().addListener((observableValue, toggle, t1) -> {
		...
		confidence.selectedToggleProperty().addListener((observableValue, toggle, t1) -> {
