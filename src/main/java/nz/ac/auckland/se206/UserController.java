...
public class UserController {
	...
	@FXML
	private AnchorPane paneOnUserOne;

	@FXML
	private JFXCheckBox boxOnEnable;

	@FXML
	private AnchorPane paneOnUserTwo;

	@FXML
	private AnchorPane paneOnUserThree;

	@FXML
	private ImageView imageOnStartUserOne;

	@FXML
	private ImageView imageOnDeleteUserOne;

	@FXML
	private ImageView imageOnStartUserTwo;

	@FXML
	private ImageView imageOnDeleteUserTwo;

	@FXML
	private ImageView imageOnStartUserThree;

	@FXML
	private ImageView imageOnDeleteUserThree;

	@FXML
	private ImageView imageStarUserOne;

	@FXML
	private ImageView imageOnBack;

	@FXML
	private ImageView imageStarUserTwo;

	@FXML
	private ImageView imageStarUserThree;

	@FXML
	private Label labelOnUserOne;

	@FXML
	private Label labelOnUserTwo;
