...
/**
 * This class is a controller for the canvas page, where the game is played. The
 * user can draw on, erase from, and reset the canvas, as well as a few other
 * functions.
 */
public class CanvasController extends App {
	...
	private final javafx.event.EventHandler<MouseEvent> onRunEvent = new javafx.event.EventHandler<>() {
	...
	private final javafx.event.EventHandler<MouseEvent> onRunEventTwo = new javafx.event.EventHandler<>() {
	...
	@FXML
	private JFXButton buttonOnSave;

	@FXML
	private ImageView buttonOnHint;

	@FXML
	private JFXButton buttonOnReady;
	...
	@FXML
	private Label labelTextDefinition;
	...
	@FXML
	private ImageView imageOnLoading;
	@FXML
	private ImageView imageSmile;
	@FXML
	private ImageView imageSad;
	...
	/**
	 * set accuracy which is the number of predictions allowed to win the game based
	 * on the settings
	 *
	...
	/**
	 * set the amount of time allowed in a game based on the settings in local
	 * repository
	 *
	...
	/**
	 * this method sets the confidence level of the game based on the settings in
	 * repository
	 *
	...
	/**
	 * this method sets up a new word based on the difficulty settings chosen from
	 * the profile scene
	 *
	 * @throws IOException
	 * @throws URISyntaxException
	...
	/**
	 * this methods sets up the basic fade in transition animation between different
	 * scenes
	 */
	 ...
	 * current drawing, queries the DL model and prints on the console the top 10
	...
	/**
	 * this method tells the user whether the game is won based on the result
	 * prediction list given
	 *
	...
	/**
	 * this method sets up the fade out transition animation from the current scene
	...
	/**
	 * this method sets up the basic parameter for the current scene to fade out to
	 * the stats scene
	 *
	...
	/**
	 * this method loads the stats scene and is used when the fade out transition
	...
	/**
	 * this method sets up the timer and refreshing prediction list per second for
	 * the GUI and also automatically update when the user has won or lost
	 *
				...
				if (interval > 0 && !score) {
					...
					Platform.runLater(() -> {
						try {
							...
							List<Classification> predictionResult = model.getPredictions(getCurrentSnapshot(), 10);
							List<Classification> predictions = model.getPredictions(getCurrentSnapshot(),
									numberOfWords);
	...
	/**
	 * this method resets the scene and the timer to get a new word of the same
	 * category
	 *
	 * @param event an ongoing action event
	 */
	...
	/**
	 * this method sets up the eraser feature of the canvas and supports the switch
	 * between pencil and eraser
	 *
	 * @param event an ongoing action event
	 */
	@FXML
	...
	/**
	 * this method allows the current screen shots to be saved to the files of a
	 * destination we want
	 *
	 * @throws IOException
	 */
	...
	/**
	 * this method sets up the click animation of a hint when the mouse is clicked
	 * on it
	 */
	@FXML
	...
	/**
	 * this method sets up the click animation of a hint when the mouse is entered
	 * on it
	 */
	@FXML
	...
	/**
	 * this method sets up the click animation of a hint when the mouse is exited on
	 * it
	 */
	@FXML
	...
	/**
	 * this method sets up the click animation of a hint when the mouse is pressed
	 * on it
	 */
	@FXML
